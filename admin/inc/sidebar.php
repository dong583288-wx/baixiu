...
<div class="aside">
  ...
  <ul class="nav">
    ...
    <?php $is_menu_page = in_array($current_page, array('nav-menus', 'slides', 'settings')); ?>

    <li<?php echo $is_menu_page ? ' class="active"' : '' ?>>
      ...
      <ul id="menu-settings" class="collapse<?php echo $is_menu_page ? ' in' : '' ?>">

        <li<?php echo $current_page === 'nav-menus' ? ' class="active"' : '' ?>><a href="
        nav-menus.php">导航菜单</a></li>
